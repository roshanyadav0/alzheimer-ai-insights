      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <Button variant="outline" className="mr-2 border-alzheimer-secondary text-alzheimer-secondary hover:bg-alzheimer-tertiary">
              Login
            </Button>
            <Button className="bg-alzheimer-primary hover:bg-alzheimer-accent text-white">
              Join Research
            </Button>
          </div>
      ...
      <div className={`sm:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <div className="flex flex-col space-y-2 px-3 py-2">
            <Button variant="outline" className="w-full border-alzheimer-secondary text-alzheimer-secondary hover:bg-alzheimer-tertiary">
              Login
            </Button>
            <Button className="w-full bg-alzheimer-primary hover:bg-alzheimer-accent text-white">
              Join Research
            </Button>
          </div>
        </div>
